...
# height denoted by buildings[i]. All of the buildings face the same direction,
# and this direction is either east or west, denoted by the input string named
# direction, which will always be equal to either "EAST" or "WEST". In relation
# to the input array, you can interpret these directions as right for east and
# left for west.
